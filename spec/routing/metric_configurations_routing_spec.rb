...
describe MetricConfigurationsController do
  describe "routing" do
    it { should route(:get, '/mezuro_configurations/1/metric_configurations/1/choose_metric').
                  to(controller: :metric_configurations, action: :choose_metric, mezuro_configuration_id: "1", id: "1") }
    it { should route(:get, '/mezuro_configurations/1/metric_configurations/new').
