...
* Services (job queues, cache servers, search engines, etc.)
  ...
  *Kalibro Processor* - version 0.9.2 (https://github.com/mezuro/kalibro_processor/archive/v0.9.2.tar.gz)
  ...
  *Kalibro Configurations* - version 1.0.0 (https://github.com/mezuro/kalibro_configurations/archive/v1.0.0.tar.gz)
...
Copyright (c) 2013-2015 The Author developers.
