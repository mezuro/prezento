...
* Services (job queues, cache servers, search engines, etc.)
  ...
  Kalibro Processor, Kalibro Configurations and Analizo are necessary to set up properly your environment.

  The clones of Kalibro processor and Kalibro configurations must be in the same directory of the Prezento.
  something like +mezuro/prezento+, +mezuro/kalibro_configurations+, +mezuro/kalibro_processor+.

  <b>Kalibro Processor</b>
  ...
  You can find it at https://github.com/analizo/analizo
  You have follow the steps of the INSTALL.md
  https://github.com/analizo/analizo/blob/master/INSTALL.md
